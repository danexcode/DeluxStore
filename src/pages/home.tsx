      ...
      <section className="bg-neutral-50 px-10 py-16 text-neutral-900 flex flex-col items-center">
        ...
        <section className="grid grid-cols-2 max-md:grid-cols-1 w-[80%] min-h-64 gap-8 mt-6 justify-items-center">
          ...
          >
            ...
            <p className="max-lg:hidden absolute text-4xl font-light text-white bottom-12 left-4">
              Vive el cine en casa
            </p>
            <img
          ...
          >
            ...
            <p className="max-lg:hidden absolute text-4xl font-light text-white bottom-4 left-4 drop-shadow-md">
              Sonido que <br /> te envuelve
            </p>
            <img
              className="object-cover h-full w-full"
          ...
          >
            ...
            <p className="max-lg:hidden absolute text-2xl font-light text-white bottom-4 left-4 drop-shadow-md">
